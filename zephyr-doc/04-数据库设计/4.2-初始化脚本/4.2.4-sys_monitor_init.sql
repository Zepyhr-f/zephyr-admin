...
-- 1. 安全审计顶级菜单
-- ----------------------------
INSERT IGNORE INTO sys_menu (id, menu_code, parent_code, menu_name, menu_type, path, component, perms, icon, order_num, status, tenant_code, create_user, create_time)
...
-- ----------------------------
INSERT IGNORE INTO sys_role_menu (role_code, menu_code) VALUES 
