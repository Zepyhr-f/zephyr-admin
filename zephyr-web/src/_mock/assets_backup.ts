...
export const DB_MENU: Menu[] = [
	...
	},
	{
		...
		type: MENU,
		path: "/audit/login",
		component: "/pages/management/system/login-log",
	},
	{
		id: "audit_oper",
		parentId: "audit",
		...
		type: MENU,
		path: "/audit/oper",
		component: "/pages/management/system/oper-log",
	},
	{
		id: "audit_online",
		parentId: "audit",
		...
		type: MENU,
		path: "/audit/online",
		component: "/pages/management/system/online",
	},
	{
		id: "monitor",
		parentId: "group_pages",
	...
	},
	{
		...
		type: MENU,
		path: "/system/config",
		component: "/pages/management/system/config",
	},
	{
		id: "tools_gen",
		parentId: "tools",
		...
		type: MENU,
		path: "/tool/generator",
		component: "/pages/management/tool/generator",
	},
	// menulevel
	{
		id: "menulevel",
...
export const DB_USER: User[] = [
	...
	{ id: "user_test_id", username: "test", password: "123456", avatar: faker.image.avatarGitHub(), email: "test@slash.com" },
	{ id: "user_guest_id", username: "guest", password: "123456", avatar: faker.image.avatarGitHub(), email: "guest@slash.com" },
];
